...
angular.module('Moodtracker', ['ionic', 'config', 'firebase', 'd3','nvd3ChartDirectives', 'ui.router', 'uiGmapgoogle-maps', 'timer', 'Moodtracker.controllers', 'Moodtracker.services', 'Moodtracker.directives'])
